...
/**
 * Created by ericjohndixon on 8/10/16.
 */
//var canvas = document.getElementById('canvas'),
//    ctx = canvas.getContext('2d');
//ctx.save();
//ctx.fillStyle('#f00'); //red
//ctx.fillRect(10,10,20,20); //x, y, width, height
//
//ctx.restore();
//ctx.fillText('Hello world', 40, 25);
...
//    let dataAverage = data.reduce((prev, curr) = > {
//            return prev + current;
//}) /
//    data.length;
//
//    ctx.fillStyle = dataAverage < 200 ? "#fff" : "#000"; // different color copyright
//
//}
//
//////
...
//frameRate = 1000/60
//
//angle = 360 * (new Date().getMilliseconds() / 1000);
//
//
////canvas is hardware accelerated on mobile device and desktop, wherein css animations arent
(function () {
  'use strict';
